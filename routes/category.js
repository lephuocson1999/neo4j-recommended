...
route.get('/list', ROLE_ADMIN, async (req, res) => {
    ...
    renderToView(req, res, 'dashboard/pages2/list-category', {})
});

route.post('/new-category', async(req, res) =>{
...
route.get('/new-category', ROLE_ADMIN, async (req, res) => {
    ...
    renderToView(req, res, 'dashboard/pages2/add-category', {})
});
...
route.get('/update/:id', async(req, res)=>{
    ...
    renderToView(req, res, 'dashboard/pages2/update-category', { category :inforCategory.data._fields[0] });
...
route.post('/update',async(req, res)=>{
  ...
  console.log({categoryName, maleManiority, oldMajority});
